...
//        rawBook.paintingList
    ...
    override func viewDidLoad() {
        ...
        blendModeButton.setBackgroundImage(#imageLiteral(resourceName: "overlay.png"), for: .normal)
        blendModeButton.setBackgroundImage(#imageLiteral(resourceName: "mixed.png"), for: .selected)
